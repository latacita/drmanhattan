...
\input{arquitectura/arquitectura.tex}
...
% Capítulo 6: Ejemplo de una iteración
\input{iteracion2/iteracion2.tex}

%% Describe la que más te guste

% Cap\'itulo 7: Construcci\'on, Implementaci\'on, Pruebas y Despliegue

%% Detalles de implementación

\input{implementacion/implementacion.tex}

% Cap\'itulo 8: Discusi\'on, Conclusiones y Trabajos Futuros

\input{futuro/futuro.tex}
